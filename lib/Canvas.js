...
class Canvas {
    constructor(canvas = document.createElement('canvas'), width = 300, height = 300) {
        ...
        this.moveToVec = (vec = new Vector_1.Vector(0, 0, 0)) => {
            this.ctx.moveTo(vec.x, vec.y);
        };
        this.lineToVec = (vec = new Vector_1.Vector()) => {
         ...
         * @param img
         */
        this.drawImage = (img, pos = new Vector_1.Vector(), size = new Vector_1.Vector(this.width, this.height)) => {
